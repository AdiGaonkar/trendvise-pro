...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: {
      discounted: '₹75,000/Monthly',
    },
    description: "*All Prices are inclusive if GST.",
    features: [
      'Get One research alert of BankNifty or NIFTY Intraday per day',
      'Get Service through WhatsApp broadcast message.',
      ...
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
        {tiers.map((tier, tierIdx) => (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-x-2 text-2xl sm:text-2xl mt-2">
              {tier.priceMonthly.original && (
